...
<link rel="stylesheet" href="assets/css/style.css"></link>
        ...
        <a href="students.html" className="btn btn-outline-gray me-2 active"><i className="feather-list"></i></a>
        <a href="students-grid.html" className="btn btn-outline-gray me-2"><i className="feather-grid"></i></a>
        <a href="#" className="btn btn-outline-primary me-2"><i className="fas fa-download"></i> Download</a>
        <a href="add-student.html" className="btn btn-primary"><i className="fas fa-plus"></i></a>
        </div>
        </div>
        </div>
        ...
        <script src="assets/js/jquery-3.7.1.min.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        
        <script src="assets/js/bootstrap.bundle.min.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        
        <script src="assets/js/feather.min.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        
        <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        
        <script src="assets/plugins/datatables/datatables.min.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        
        <script src="assets/js/script.js" type="10cf0184c16387f9e2782c50-text/javascript"></script>
        <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="10cf0184c16387f9e2782c50-|49" defer></script></body>)
}