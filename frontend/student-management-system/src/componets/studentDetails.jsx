...
<link rel="stylesheet" href="assets/css/style.css"></link>
        ...
        <div className="views-personal">
        <h4>Email</h4>
        <h5><a href="https://preschool.dreamstechnologies.com/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="ceaaafa7bdb78ea9a3afa7a2e0ada1a3">[email&#160;protected]</a></h5>
        </div>
        </div>
        <div className="personal-activity">
        <div className="personal-icons">
        ...
        <script data-cfasync="false" src="../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="assets/js/jquery-3.7.1.min.js" type="b9b21180094579b54f66a367-text/javascript"></script>
        
        <script src="assets/js/bootstrap.bundle.min.js" type="b9b21180094579b54f66a367-text/javascript"></script>
        
        <script src="assets/js/feather.min.js" type="b9b21180094579b54f66a367-text/javascript"></script>
        
        <script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="b9b21180094579b54f66a367-text/javascript"></script>
        
        <script src="assets/js/script.js" type="b9b21180094579b54f66a367-text/javascript"></script>
        <script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="b9b21180094579b54f66a367-|49" defer></script></body>)
}