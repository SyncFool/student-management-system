...
<li><a href="invoices-overdue.html" className="active">Overdue</a></li>
...
<td>14 Mar 2022</td>
<td>18 Mar 2022</td>
<td><span className="badge bg-danger-light">Overdue 4 days</span></td>
<td className="text-end">
<a href="edit-invoice.html" className="btn btn-sm btn-white text-success me-2"><i className="far fa-edit me-1"></i> Edit</a>
<a className="btn btn-sm btn-white text-danger" href="#" data-bs-toggle="modal" data-bs-target="#delete_paid"><i className="far fa-trash-alt me-1"></i>Delete</a>
</td>
...
<td>24 Mar 2022</td>
<td>30 Mar 2022</td>
<td><span className="badge bg-danger-light">Overdue 6 days</span></td>
<td className="text-end">
<a href="edit-invoice.html" className="btn btn-sm btn-white text-success me-2"><i className="far fa-edit me-1"></i> Edit</a>
<a className="btn btn-sm btn-white text-danger" href="#" data-bs-toggle="modal" data-bs-target="#delete_paid"><i className="far fa-trash-alt me-1"></i>Delete</a>
</td>
...
<script src="assets/js/jquery-3.7.1.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/js/bootstrap.bundle.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/js/feather.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/plugins/select2/js/select2.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/plugins/datatables/jquery.dataTables.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>
<script src="assets/plugins/datatables/datatables.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/plugins/moment/moment.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>
<script src="assets/js/bootstrap-datetimepicker.min.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>

<script src="assets/js/script.js" type="970b9a2dce4f4fc5121b4fbf-text/javascript"></script>
<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="970b9a2dce4f4fc5121b4fbf-|49" defer></script></body>
