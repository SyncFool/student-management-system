export default InvoicesCancelled;
function InvoicesCancelled(){
    return (
        <body>
...
<li><a href="invoices-cancelled.html" className="active">Cancelled</a></li>
</ul>
</div>
</div>
...
<script src="assets/js/jquery-3.7.1.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/js/bootstrap.bundle.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/js/feather.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/plugins/slimscroll/jquery.slimscroll.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/plugins/select2/js/select2.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/plugins/datatables/jquery.dataTables.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>
<script src="assets/plugins/datatables/datatables.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/plugins/moment/moment.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>
<script src="assets/js/bootstrap-datetimepicker.min.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>

<script src="assets/js/script.js" type="ebaad3cd56b6ef831dfaa1d9-text/javascript"></script>
<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="ebaad3cd56b6ef831dfaa1d9-|49" defer></script></body>
