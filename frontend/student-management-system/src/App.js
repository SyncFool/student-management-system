...
<!-- /Sidebar --> */}
              ...
              <div className="card card-chart">
                <div className="card-header">
                  <div className="row align-items-center">
                    ...
                    <div className="col-6">
                      <ul className="chart-list-out">
                        <li><span className="circle-blue"></span>Girls</li>
                        <li><span className="circle-green"></span>Boys</li>
                        <li className="star-menus">
                          <a href="javascript:;"
                            ><i className="fas fa-ellipsis-v"></i
                          ></a>
      ...
      type="878b38b337b94a862a196689-text/javascript"
    ></script>
    ...
    <script
      ...
      data-cf-settings="878b38b337b94a862a196689-|49"
      defer
    ></script>
       {/* <!-- Footer -->
       <!-- / Footer --> */}
